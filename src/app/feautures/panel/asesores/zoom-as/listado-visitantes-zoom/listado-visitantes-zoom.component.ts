...
@Component({
  selector: 'app-listado-visitantes-zoom',
  templateUrl: './listado-visitantes-zoom.component.html',
  styleUrls: ['./listado-visitantes-zoom.component.css']
})
export class ListadoVisitantesZoomComponent implements OnInit {
